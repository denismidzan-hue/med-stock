...
export default function AddMedicinePage() {
  ...
  const [showScannedEntry, setShowScannedEntry] = useState(false);
      ...
      <div className="bg-white border border-slate-200 rounded-3xl p-8 shadow-sm">
        ...
        {showScannedEntry && (
          <div className="mb-6 bg-slate-50 rounded-2xl p-6">
            <h3 className="text-lg font-semibold text-slate-900 mb-4">Skeniran izdelek</h3>
            <div className="mb-5">
