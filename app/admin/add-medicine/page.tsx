      ...
      <div className="bg-white border border-slate-200 rounded-3xl p-8 shadow-sm">
        ...
        <div className="mb-5">
          ...
          <input
            ...
            className="w-full h-14 px-4 rounded-2xl border border-slate-300 bg-white text-slate-900 placeholder:text-slate-300 outline-none focus:ring-2 focus:ring-slate-300 [-webkit-text-fill-color:#0f172a]"
          />
        </div>
