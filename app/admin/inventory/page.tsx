    ...
    <div className="p-4 md:p-8">
      ...
      <div className="mb-4">
        <input
          ...
          className="w-full max-w-md rounded-2xl border border-slate-300 bg-white px-4 py-3 text-slate-900 placeholder:text-slate-400 placeholder:opacity-60 outline-none focus:ring-2 focus:ring-emerald-500"
        />
      </div>
